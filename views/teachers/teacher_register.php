            ...
            <div class="content">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                        ...
                        <div class="modal" id="agregar-profesor-modal">
                    ...
                    <div class="intro-y col-span-12 lg:col-span-8">
                        <div class="intro-y box p-5">
                            ...
                            <form>
                                ...
                                <div class="mt-3">
                                    <label for="cede" class="form-label">Cede</label>
                                    <input id="cede" type="text" class="input w-full border mt-2">
                                </div>
                                
                                <div class="mt-3">
                                    <label for="programa" class="form-label">Programa</label>
                                    <input id="programa" type="text" class="input w-full border mt-2">
                                </div>
