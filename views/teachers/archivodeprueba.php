        ...
        <div class="content">
            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
                            ...
                            <div class="modal-body">
                                <div class="grid grid-cols-12 gap-4 row-gap-3">
                                    ...
                                    <div class="col-span-12 sm:col-span-6">
                                        ...
                                        <input type="text" class="input w-full border mt-2 flex-1" placeholder="Teléfono">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer text-right">
                                <button type="button" data-dismiss="modal" class="button w-20 bg-theme-6 text-white">Cancelar</button>
                    ...
                    <!-- Caja de búsqueda y resultados por página -->
                    <form id="search-form" method="GET" action="" class="flex items-center">
                        ...
                        <button type="submit" class="absolute inset-y-0 right-0 flex items-center pr-3" style="border: none; background: none;">
                            <img src="path-to-your-lupa-image.png" alt="Buscar" style="width: 20px; height: 20px;">
                        </button>
                        <input type="hidden" name="results_per_page" id="results_per_page" value="<?= htmlspecialchars($results_per_page) ?>">
                    </form>
                    
                    <div class="hidden md:block mx-auto text-gray-600">Mostrar</div>
                    <div class="w-20">
                    ...
                    <div class="hidden md:block mx-auto text-gray-600">Resultados</div>
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <a id="clear-search" class="button text-white bg-theme-6 shadow-md mr-2">Limpiar</a>
                    </div>
                </div>
                
                <!-- Aquí puedes agregar el contenido de tu tabla de profesores -->
                ...
                <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-no-wrap items-center">
                    <ul class="pagination">
                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                            <li>
                                <a class="pagination__link <?= ($i == $page) ? 'pagination__link--active' : '' ?>" href="?page=<?= $i ?>&search=<?= urlencode($search) ?>&results_per_page=<?= $results_per_page ?>"><?= $i ?></a>
                            </li>
                        <?php endfor; ?>
                    </ul>
                </div>
