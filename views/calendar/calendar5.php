...
<body class="app">
    <div class="flex">
        ...
        <div class="content">
            ...
            <button id="openModal" class="button bg-theme-1 text-white mt-5 ml-5">Agregar Nuevo Horario2</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Cierra el modal si se hace clic fuera de él o en el botón de cerrar
            ...
            // Envía el formulario de añadir horario
            document.getElementById('addScheduleForm').addEventListener('submit', function(event) {
                event.preventDefault();
                // Aquí puedes procesar los datos del formulario con JavaScript o enviarlos a través de AJAX
                // Por ejemplo:
                var sede = document.getElementById('modal-sede').value;
                var dia = document.getElementById('modal-dia').value;
                
                // Aquí podrías enviar los datos a través de AJAX si es necesario
                console.log("Sede: " + sede + ", Día: " + dia);
